...
enum{
    ...
    UART_SOC_OWNER_REC_PLAY_STOP= 0x25,
    UART_SOC_OWNER_REC_SAVE      = 0x26,
    UART_SOC_CALM_MUSIC_PLAY     = 0x27,
    UART_SOC_CALM_MUSIC_PLAY_STOP= 0x28,
    ...
    UART_SOC_ULTRA_EMIT_EVT     = 0x68,
    UART_SOC_WORK_STATE_EVT     = 0x80,
    UART_SOC_BARK_DETECTED_EVT  = 0x81,
    UART_SOC_MEASURE_EXEC_EVT   = 0x82,
    UART_SOC_SESSION_RESULT_EVT = 0x83,
    ...
    UART_SOC_SNACK_FEED_EVT     = 0x89,  /* SOC requests MCU snack feeding */
};
