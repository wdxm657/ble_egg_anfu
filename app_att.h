...
typedef enum
{
	...
	/**********************************************************************************************/
	CUSTOM_COUNTER_PS_H,					//UUID: 2800, 	VALUE: custom counter service uuid
	CUSTOM_COUNTER_WRITE_CD_H,				//UUID: 2803, 	VALUE:  			Prop: read | write | write_without_rsp
	CUSTOM_COUNTER_WRITE_DP_H,				//UUID: custom uuid,  VALUE: counter value (write)
	CUSTOM_COUNTER_WRITE_DESC_H,			//UUID: 2901, 	VALUE: write char user description
	CUSTOM_COUNTER_READ_CD_H,				//UUID: 2803, 	VALUE:  			Prop: read | notify
	CUSTOM_COUNTER_READ_DP_H,				//UUID: custom uuid,  VALUE: counter value (read/notify)
